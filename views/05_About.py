...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 14px; margin-bottom: 24px;">
    <div class="glass-card" style="padding: 16px;">
        <div style="font-size: 0.90rem; font-weight: 700; color: #38BDF8; margin-bottom: 6px;">
...
<div class="glass-card" style="padding: 16px 18px; margin-bottom: 24px;">
    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 14px; font-size: 0.78rem; color: #9AA7BD;">
        <div>
    ...
    <div style="font-size: 0.72rem; color: #64748B; margin-top: 10px; border-top: 1px solid rgba(255,255,255,0.06); padding-top: 8px;">
...
<div class="glass-card" style="padding: 16px 18px; margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
    <div>
        <div style="font-size: 0.88rem; font-weight: 700; color: #E8EDF5;">
            Leave-One-Episode-Out (LOEO 37-Fold) Cross-Validation & Baseline Benchmarks
        </div>
        <div style="font-size: 0.76rem; color: #9AA7BD; margin-top: 2px;">
