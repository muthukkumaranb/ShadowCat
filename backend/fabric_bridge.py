...
"""
    ...
    cmd = [
        ...
        "ubuntu", "sh", "-c",
        "apt-get update -qq && apt-get install -y -qq dos2unix > /dev/null && dos2unix /d/sih2026/fabric-experiment/invoke_temp.sh > /dev/null 2>&1 && bash /d/sih2026/fabric-experiment/invoke_temp.sh"
    ]
...
"""
    ...
    cmd = [
        ...
        "-v", r"d:\sih2026:/d/sih2026",
        "ubuntu", "sh", "-c",
        "apt-get update -qq && apt-get install -y -qq dos2unix > /dev/null && dos2unix /d/sih2026/fabric-experiment/query_temp.sh > /dev/null 2>&1 && bash /d/sih2026/fabric-experiment/query_temp.sh"
    ]
